...
#include <pp4/pp4Action.h> //reference action message in this package
...
void doneCb(const actionlib::SimpleClientGoalState& state,
        const pp4::pp4ResultConstPtr& result) {
...
void feedbackCb(const pp4::pp4FeedbackConstPtr& fdbk_msg) {
...
///////////////////////// way points..//////////////////////////////////
    ...
    pose_stamped.pose.position.x=3.5; 
    pose_stamped.pose.position.y=13;   
    goal.nav_path.poses.push_back(pose_stamped);
...
//////////////////two different goals goal and goal1  ///////////////////////////
        ...
        actionlib::SimpleActionClient<pp4::pp4Action> action_client("way_point", true);
        ...
        if(!g_lidar_alarm){
           ...
           ROS_INFO("goal");firsttime=0;firsttimespin=1;}
              ...
              if(firsttimespin==1){  ROS_INFO("goal1");
                ...
                if(turndir) 
              action_client.sendGoal(goal2, &doneCb, &activeCb, &feedbackCb);
            else action_client.sendGoal(goal1, &doneCb, &activeCb, &feedbackCb);
              firsttime=1;
              firsttimespin=0;
              main_timer.sleep();}
